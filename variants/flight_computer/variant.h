...
#define PIN_A0    0 //this isn't used, however the analogRead function uses it so defining it here means no modifications to the local arduino core are necessary
