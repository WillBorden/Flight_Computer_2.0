...
SPIClassSAMD FLASH_SPI(&PERIPH_SPI, PIN_SPI_MISO, PIN_SPI_SCK, PIN_SPI_MOSI, PAD_SPI_TX, PAD_SPI_RX);
SPIClassSAMD SPI(&PERIPH_SD_SPI, PIN_SD_SPI_MISO, PIN_SD_SPI_SCK, PIN_SD_SPI_MOSI, PAD_SD_SPI_TX, PAD_SD_SPI_RX);
